...
namespace PrikolShopListImplement.Implements
{
    public class OrderLogic : IOrderLogic
    {
        ...
        {
            Order.GiftBoxId = model.GiftBoxId == 0 ? Order.GiftBoxId : model.GiftBoxId;
        ...
        {
            string giftBoxName = "";
            for (int j = 0; j < source.GiftBoxes.Count; ++j)
            {
                if (source.GiftBoxes[j].Id == Order.GiftBoxId)
                {
                    giftBoxName = source.GiftBoxes[j].GiftBoxName;
                    break;
                }
            }
