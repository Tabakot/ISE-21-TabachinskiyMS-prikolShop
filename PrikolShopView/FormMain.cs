...
namespace PrikolShopView
{
    public partial class FormMain : Form
    {
        ...
        {
            var form = Container.Resolve<FormGiftBoxes>();
            form.ShowDialog();
        }
        ...
        private void списокПодарковToolStripMenuItem_Click(object sender, EventArgs e)
        {
            using (var dialog = new SaveFileDialog { Filter = "docx|*.docx" })
            {
                ...
                {
                    report.SaveGiftsToWordFile(new ReportBindingModel
                    {
                        FileName =
                   dialog.FileName
                    });
        ...
        private void элементыПодарочныхНаборовToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var form = Container.Resolve<FormReportBoxes>();
            form.ShowDialog();
        }
