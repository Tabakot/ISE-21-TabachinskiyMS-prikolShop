...
namespace PrikolShopBusinessLogic.BusinessLogics
{
    class SaveToPdf
    {
        public static void CreateDoc(PdfInfo info)
        {
            ...
            foreach (var elem in columns) { table.AddColumn(elem);
            }
        ...
        private static void CreateRow(PdfRowParameters rowParameters) { Row row = rowParameters.Table.AddRow();
            for (int i = 0; i < rowParameters.Texts.Count; ++i)
            {
                ...
                { 
                    ...
                    BorderWidth = 0.5, ParagraphAlignment = rowParameters.ParagraphAlignment
                });
            }
        }
